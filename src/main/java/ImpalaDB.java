...
public class ImpalaDB {
    ...
    public static int createPartitionTable(String targetDB, String targetTable, Connection db, String schema, String partitionClause, String tableFormat)
        throws SQLException
    {
        ...
        return HiveDB.execUpdate(db, sql.toString());
    ...
    public static int updatePartitions(Connection db, List<Partition> parts,
            ...
            throws SQLException
    {
        ...
        for(Partition part: parts)
        {
            ...
            ret += HiveDB.execUpdate(db, sql.toString());
        }
